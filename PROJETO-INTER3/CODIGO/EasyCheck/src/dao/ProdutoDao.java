...
public class ProdutoDao {
	...
	public void inserirProdutosBanco(Produto produto, int numNotaFiscal) {	
		...
		try {
			...
			queryProdutos = "call calculaPrecoTotal(" + numNotaFiscal + ", " + produto.getCod_produto() +", " + produto.getQtd() + ", " + produto.getPreco_uni() + ")";
